...
var krpanoplugin = function() {
    ...
    local.registerplugin = function(krpanointerface, pluginpath, pluginobject) {
        ...
        plugin.get_qr_image = get_qr_image;
    }
   ...
   */
        ...
        var createImgBase64 = function(width, height, getPixel, alt) {
    ...
    // Plugin functions 
    function get_qr_image(des) {
        
        var create_qrcode = function(text, typeNumber, errorCorrectLevel, table) {
            var qr = qrcode(typeNumber || 4, errorCorrectLevel || 'M');
            qr.addData(text);
            qr.make();
            return qr.createImgBase64(8);
        };

        var qr = qrcode(4, 'M');
        imgData = create_qrcode(window.location.href, 8, "M");
        krpano.set(des, imgData);
    }
};
